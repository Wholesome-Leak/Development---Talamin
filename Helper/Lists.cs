...
using WholesomeDungeons.Profiles.WotLK.ForgeOfSouls;
using WholesomeDungeons.Profiles.Classic.RagefireChasm;
using WholesomeDungeons.Profiles.Classic.TheDeadmines;
using WholesomeDungeons.Profiles.Classic.ShadowfangKeep;
using WholesomeDungeons.Profiles.Classic.StormwindStockade;
using WholesomeDungeons.Profiles.Classic.BlackfathomDeeps;
using WholesomeDungeons.Profiles.Classic.RazorfenKraul;
using WholesomeDungeons.Profiles.Classic.ZulFarrak;
using WholesomeDungeons.Profiles.Classic.WailingCaverns;
using WholesomeDungeons.Profiles.Classic.Gnomregan;
using WholesomeDungeons.Profiles.Classic.ScarletGraveyard;
using WholesomeDungeons.Profiles.Classic.ScarletLibrary;
using WholesomeDungeons.Profiles.Classic.ScarletCathedral;
using WholesomeDungeons.Profiles.Classic.ScarletArmory;
using WholesomeDungeons.Profiles.Classic.Uldaman;
using WholesomeDungeons.Profiles.Classic.Uldaman2;
using WholesomeDungeons.Profiles.Classic.SethekkHalls;
using WholesomeDungeons.Profiles.Classic.RazorfenDowns;
using WholesomeDungeons.Profiles.Classic.MaraudonEarthSongFalls;
using WholesomeDungeons.Profiles.Classic.MaraudonFoulsporeCavern;
using WholesomeDungeons.Profiles.Classic.MaraudonTheWickedGrotto;
using WholesomeDungeons.Profiles.Classic.TheTempleOfAtalHakkar;
using WholesomeDungeons.Profiles.Classic.BlackrockDepthsPrison;
using WholesomeDungeons.Profiles.Classic.BlackrockSpire;
using WholesomeDungeons.Profiles.Classic.BlackrockUpperCity;
using WholesomeDungeons.Profiles.Classic.DireMaulEast;
using WholesomeDungeons.Profiles.Classic.DireMaulNorth;
using WholesomeDungeons.Profiles.Classic.DireMaulWest;
using WholesomeDungeons.Profiles.Classic.Scholomance;
...
namespace WholesomeDungeons.Helper
{
    ...
    class Lists
    {
        ...
        {
            new Dungeons { Name="Blackfathom Deeps",DungeonId =10, MapId=48, EntranceLoc=new Vector3(4249.812, 750.041, -23.03586, "None"), profile = new BlackfathomDeeps() },
            new Dungeons { Name="Blackrock Depths - Prison",DungeonId =30, MapId=230, EntranceLoc=new Vector3(-7177.132, -932.0781, 165.9823, "None"), Start=new Vector3(458.32, 26.52, -70.67339, "None"), profile = new BlackrockDepthsPrison() },
            new Dungeons { Name="Blackrock Depths - Upper City",DungeonId =276, MapId=230, EntranceLoc=new Vector3(-7177.132, -932.0781, 165.9823, "None"), Start=new Vector3(872.8282, -232.221, -43.75124, "None"), profile = new BlackrockUpperCity() },
            new Dungeons { Name="Blackrock Spire",DungeonId =32, MapId=229, EntranceLoc=new Vector3(-7522.83, -1233.157, 285.7446, "None"), profile = new BlackrockSpire() },
            new Dungeons { Name="Dire Maul West",DungeonId =36, MapId=429, EntranceLoc=new Vector3(0, 0,0, "None"), Start=new Vector3(31.5609, 159.45, -3.4777, "None"), profile  = new DireMaulWest() },
            new Dungeons { Name="Dire Maul North",DungeonId =38, MapId=429, EntranceLoc=new Vector3(0, 0,0, "None"), Start=new Vector3(255.249, -16.0561, -2.58737, "None"), profile= new DireMaulNorth() },
            new Dungeons { Name="Dire Maul East",DungeonId =34, MapId=429, EntranceLoc=new Vector3(0, 0,0, "None"), Start=new Vector3(44.4499, -154.822, -2.71364, "None"), profile = new DireMaulEast() },
            new Dungeons { Name="Gnomeregan",DungeonId =14, MapId=90, EntranceLoc=new Vector3(-5162.39, 933.34, 257.1808, "None"), profile = new Gnomregan() },
            new Dungeons { Name="Maraudon - Foulspore Cavern", MapId=349, EntranceLoc=new Vector3(0, 0,0, "None"), Start=new Vector3(1019.69, -458.31, -43.43, "None"), profile  = new MaraudonFoulsporeCavern() },
            new Dungeons { Name="Maraudon - The Wicked Grotto", MapId=349, EntranceLoc=new Vector3(0, 0,0, "None"), Start=new Vector3(752.91, -616.53, -33.11, "None"), profile = new  MaraudonTheWickedGrotto() },
            new Dungeons { Name="Maraudon - Earth Song Falls", MapId=349, EntranceLoc=new Vector3(0, 0,0, "None"), Start=new Vector3(419.84, 11.3365, -132.194), profile = new MaraudonEarthSongFalls() },
            new Dungeons { Name="Ragefire Chasm", DungeonId = 4,MapId=389, EntranceLoc=new Vector3(1822.122, -4430.388, -21.98243, "None"), profile= new RagefireChasm() },
            new Dungeons { Name="Razorfen Downs", DungeonId =20, MapId=129, EntranceLoc=new Vector3(-4662.351, -2533.959, 82.09897, "None"), profile = new RazorfenDowns() },
            new Dungeons { Name="Razorfen Kraul",DungeonId =16, MapId=47, EntranceLoc=new Vector3(-4459.325, -1657.642, 81.80143, "None"), profile = new RazorfenKraul() },
            new Dungeons { Name="Scarlet Monastery - Graveyard",DungeonId =18, MapId=189, EntranceLoc=new Vector3(2922.188, -798.9219, 160.333, "None"), Start=new Vector3(1688.99, 1053.48, 18.67749, "None"), profile = new ScarletGraveyard() },
            new Dungeons { Name="Scarlet Monastery - Library",DungeonId =165, MapId=189, EntranceLoc=new Vector3(2861.397, -824.2118, 160.333, "None"), Start=new Vector3(255.346, -209.09, 18.6773, "None"), profile = new ScarletLibrary() },
            new Dungeons { Name="Scarlet Monastery - Armory", DungeonId =163, MapId=189, EntranceLoc=new Vector3(2877.177, -840.0958, 160.3271, "None"), Start=new Vector3(1610.83, -323.433, 18.67379, "None"), profile = new ScarletArmory() },
            new Dungeons { Name="Scarlet Monastery - Cathedral",DungeonId =164, MapId=189, EntranceLoc=new Vector3(2923.722, -820.2943, 160.3281, "None"), Start=new Vector3(855.683, 1321.5, 18.6709, "None"), profile = new ScarletCathedral() },
            new Dungeons { Name="Scholomance",DungeonId = 2, MapId=289, EntranceLoc=new Vector3(1280.767, -2549.763, 86.29783, "None"), profile = new Scholomance() },
            new Dungeons { Name="Shadowfang Keep",DungeonId =8, MapId=33, EntranceLoc=new Vector3(-231.1921, 1571.913, 76.8921, "None"), profile = new ShadowfangKeep() },
            ...
            new Dungeons { Name="The Deadmines",DungeonId =6, MapId=36, EntranceLoc=new Vector3(-11207.45, 1681.354, 23.80899, "None"), Start=new Vector3(-16.4, -383.07, 61.78, "None"), profile= new TheDeadmines() },
            new Dungeons { Name="Stormwind Stockade",DungeonId =12, MapId=34, EntranceLoc=new Vector3(-8761.981, 847.7866, 86.25107, "None"), profile = new StormwindStockade() },
            new Dungeons { Name="The Temple of Atal'Hakkar",DungeonId =28, MapId=109, EntranceLoc=new Vector3(-10169.46, -3997.184, -113.8935, "None"), profile = new TheTempleOfAtalHakkar()},
            new Dungeons { Name="Uldaman",DungeonId =22, MapId=70, EntranceLoc=new Vector3(-6059.759, -2955.001, 209.769, "None"), Start= new Vector3(-6059.759, -2955.001, 209.769, "None"), profile  = new Uldaman() },
            new Dungeons { Name="Uldaman Echomok Door, second Entrance", DungeonId=22, MapId=70, EntranceLoc=new Vector3(-6059.759, -2955.001, 209.769, "None"), Start= new Vector3(-212.3159, 383.2488, -38.72359, "None"), profile = new Uldaman2()},
            new Dungeons { Name="Wailing Caverns",DungeonId=1, MapId=43, EntranceLoc=new Vector3(-749.3314, -2212.979, 14.59487, "None"), profile = new WailingCaverns() },
            new Dungeons { Name="Zul'Farrak",DungeonId =24, MapId=209, EntranceLoc=new Vector3(-6790.196, -2891.261, 8.902938, "None"), profile = new ZulFarrak() },
            ...
            new Dungeons { Name="Sethekk Halls",DungeonId =150, MapId=556, EntranceLoc=new Vector3(-3361.055, 4652.112, -101.0487, "None"), profile = new SethekkHalls() },
            ...
            new Dungeons{Name="The Forge of Souls",MapId = 632, profile = new ForgeOfSouls()},
        };



        public static readonly HashSet<ulong> BlackListedMobsGuidInt = new HashSet<ulong>
        { 17379391026615025678, //Alliance NPC in Shadofangkeep Cellar
          17379391026598248461 //Horde NPC in Shadofangkeep Cellar
        };
