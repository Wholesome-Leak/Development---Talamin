...
namespace WholesomeDungeons.Profiles.Classic.RagefireChasm {
    internal class RagefireChasm : Profile {
        private readonly Data _data;

        public RagefireChasm(string profileName = "Ragefire Chasm") : base(profileName) {
            _data = new Data();
        }
        ...
        protected override Step[] GetSteps() =>
            new Step[] {
                ...
                new MoveAlongPath(_data.PathToTaragaman, "Take path to Taragaman the Hungerer"),
